...
public class ExcuseApplicationController {
	...
	public ResponseEntity<ExcuseApplication> createExcuseApplication(
		...
		ExcuseApplication _excuseApplication = excuseApplicationService.save(excuseApplicationRequestData, userId);
	...
	@PreAuthorize("(hasRole('ADMIN') or hasRole('SECRETARY') or hasRole('STUDENT'))"
			+ " and #userId == authentication.principal.id")
	...
	public ResponseEntity<Map<String, Object>> getAllExcuseApplicationsByDepartmentIdSortedPaginated(
		...
		try {
            Map<String, Object> response = excuseApplicationService.findAllByDepartmentIdSortedPaginated(userId, departmentId, filter, page, size, sort);
	...
	public ResponseEntity<Map<String, Object>> getAllExcuseApplicationsByDepartmentIdAndCourseScheduleIdSortedPaginated(
		...
		try {
            Map<String, Object> response = excuseApplicationService.findAllByDepartmentIdAndCourseScheduleIdSortedPaginated(userId,
            		departmentId, courseScheduleId, filter, page, size, sort);
    		System.out.println("RESPONSE: "+response);
            if(response==null) {
                return new ResponseEntity<>(HttpStatus.NO_CONTENT);
            }
	...
	public ResponseEntity<Map<String, Object>> getAllExcuseApplicationsByDepartmentIdCourseScheduleIdAndTypeSortedPaginated(
		...
		try {
            Map<String, Object> response = excuseApplicationService.findAllByDepartmentIdCourseScheduleIdAndTypeSortedPaginated(userId,
            		departmentId, courseScheduleId, name, filter, page, size, sort);
    		System.out.println("RESPONSE: "+response);
            if(response==null) {
                return new ResponseEntity<>(HttpStatus.NO_CONTENT);
            }
	...
	public ResponseEntity<Map<String, Object>> getAllExcuseApplicationsByDepartmentIdAndTypeSortedPaginated(
		...
		try {
            Map<String, Object> response = excuseApplicationService.findAllByDepartmentIdAndTypeSortedPaginated(userId,
            		departmentId, name, filter, page, size, sort);
    		System.out.println("RESPONSE: "+response);
            if(response==null) {
                return new ResponseEntity<>(HttpStatus.NO_CONTENT);
            }
	...
	public ResponseEntity<Map<String, Object>> getAllExcuseApplicationsByDepartmentIdAndStatusSortedPaginated(
		...
		try {
            Map<String, Object> response = excuseApplicationService.findAllByDepartmentIdAndStatusSortedPaginated(userId,
            		departmentId, typeOfStatus, filter, page, size, sort);
    		System.out.println("RESPONSE: "+response);
            if(response==null) {
                return new ResponseEntity<>(HttpStatus.NO_CONTENT);
            }
	...
	public ResponseEntity<Map<String, Object>> getAllExcuseApplicationsByDepartmentIdTypeAndstatusSortedPaginated(
		...
		try {
            Map<String, Object> response = excuseApplicationService.findAllByDepartmentIdTypeAndStatusSortedPaginated(userId,
            		departmentId, name, typeOfStatus, filter, page, size, sort);
    		System.out.println("RESPONSE: "+response);
            if(response==null) {
                return new ResponseEntity<>(HttpStatus.NO_CONTENT);
            }
	...
	public ResponseEntity<Map<String, Object>> getAllExcuseApplicationsByDepartmentIdCourseScheduleIdAndStatusSortedPaginated(
		...
		try {
            Map<String, Object> response = excuseApplicationService.findAllByDepartmentIdCourseScheduleIdAndStatusSortedPaginated(userId,
            		departmentId, courseScheduleId, typeOfStatus, filter, page, size, sort);
    		System.out.println("RESPONSE: "+response);
            if(response==null) {
                return new ResponseEntity<>(HttpStatus.NO_CONTENT);
            }
	...
	public ResponseEntity<Map<String, Object>> getAllExcuseApplicationsByCompleteSearchSortedPaginated(
		...
		try {
            Map<String, Object> response = excuseApplicationService.findAllByCompleteSearchSortedPaginated(userId,
            		departmentId, courseScheduleId, name, typeOfStatus, filter, page, size, sort);
    		System.out.println("RESPONSE: "+response);
            if(response==null) {
                return new ResponseEntity<>(HttpStatus.NO_CONTENT);
            }
